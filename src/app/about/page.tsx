    ...
    <>
      ...
      <main className="min-h-screen bg-white py-8 lg:py-12">
        <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div data-aos="fade-right">
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Since 2008, we've been committed to supporting local farmers
                  and providing our community with nutritious, delicious food
                  options. Our mission is to make healthy eating convenient and
          ...
          {/* Stats Section */}
          <section className="py-16 bg-gray-50 rounded-xl border border-gray-100 mb-16">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-primary/10 rounded-full mb-4 group-hover:bg-primary/20 transition-colors duration-300 border border-primary/20">
                ...
                <div className="space-y-4">
                  {values.map((value, index) => (
                    <div key={index} className="flex items-start gap-4 group">
                      <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-300 border border-primary/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    and local farms to ensure premium quality.
                  </p>
                </div>
          ...
          <section className="py-16 bg-primary">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-white/90 mb-8 max-w-2xl mx-auto">
                Join thousands of satisfied customers who trust FreshKo for
                their grocery needs.
              </p>
              <Link
                href="/shop"
