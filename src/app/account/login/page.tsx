        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className="bg-white hover:bg-gray-50 border border-gray-200 hover:border-gray-300 rounded-full py-3 px-6 font-medium transition-all duration-300 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed w-full"
            >
            ...
            <button
              type="button"
              className="bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-full py-3 px-6 font-medium transition-all duration-300 hover:shadow-lg w-full"
            >
              <div className="flex items-center justify-center gap-3">
                <svg
