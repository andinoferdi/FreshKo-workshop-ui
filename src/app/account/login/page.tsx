        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className="btn-secondary hover-lift disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 w-full"
            >
            ...
            <button type="button" className="btn-secondary hover-lift w-full">
              <div className="flex items-center justify-center gap-3">
                <svg
