  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="w-[90%] max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          {/* Breadcrumb */}
          <div className="mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Join us and start shopping fresh groceries</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
