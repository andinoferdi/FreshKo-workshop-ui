        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 font-medium">
              Manage orders that have been shipped to customers
            </p>
          </div>
          <div className="mt-4 md:mt-0 flex items-center gap-2">
            <span className="px-4 py-2 bg-gradient-to-r from-blue-100 to-blue-200 text-blue-700 rounded-lg font-bold text-sm">
          ...
          {filteredOrders.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">
                No orders are currently shipped or try adjusting your search
              </p>
            </div>
          )}
        </div>
