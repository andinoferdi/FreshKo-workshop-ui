...
import { Plus, Minus, X, ShoppingCart, ArrowLeft, Truck, Shield } from "lucide-react"
import Header from "@/components/Header"
import Footer from "@/components/Footer"
import { useHydratedStore } from "@/lib/store"

export default function CartPage() {
  const { cart, updateQuantity, removeFromCart, getCartTotal, clearCart } = useHydratedStore()
      ...
      <main className="min-h-screen bg-gray-50 py-8 lg:py-12">
        <div className="w-[90%] max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 lg:mb-12">
            ...
            <p className="text-lg text-gray-600 mb-6">Review your items before checkout</p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button
                    ...
                    disabled={isClearing}
                    className="text-red-500 hover:text-red-700 text-sm font-semibold disabled:opacity-50 transition-colors"
                  >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-600 mb-2">{item.unit || "1 Unit"}</p>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center border border-gray-200 rounded-lg">
                            <button
                              ...
                              className="p-2 text-red-500 hover:bg-red-50 rounded-l-lg transition-colors"
                            >
                              <Minus size={16} />
                            </button>
                            ...
                            <button
                              onClick={() => updateQuantity(item.id, item.quantity + 1)}
                              className="p-2 text-green-500 hover:bg-green-50 rounded-r-lg transition-colors"
                            >
                              <Plus size={16} />
                            </button>
                          </div>
